...
**⭐️功能介绍**：以《极乐迪斯科》（Disco Elysium）24 人格系统为原型的 AI 对话 Skill。触发后，先从 24 个人格中选出 1~2 个最合适的对用户说话，再以普通助手口吻正常、完整地回答用户的问题。
...
- 不同 Agent 客户端表现能力不同（测试使用平台为 Trae Work），因此，关闭内联渲染的情况下表现较为稳定
